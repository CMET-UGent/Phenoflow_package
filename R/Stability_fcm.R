#' Ecological stability measures from flow cytometry data
#'
#' This function calculates ecological stability measures from flow cytometry
#' data (Liu et al. 2018). As an input it takes a contingency table. 
#' This can be either generated by using flowCyBar (Koch et al., 2013) or 
#' Phenoflow (Props et al., 2016). 
#' @param x a matrix or matrix-like object containing a contingency table for 
#'  the gates or bins
